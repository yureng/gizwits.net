...
namespace Gizwits
{
    public class ProductInfo
    {
        ...
        {
            if (String.IsNullOrEmpty(softAp_Prefix))
                softAp_Prefix = "XPG-GAgent-";

            Name = name;
            App_ID = app_ID;
            App_Secret = app_Secret;
            Product_Infos = product_Infos;
            SoftAp_Prefix = softAp_Prefix;
            BLE_Prefix = !String.IsNullOrEmpty(ble_Prefix) ? ble_Prefix : softAp_Prefix;
        }
    }
}
